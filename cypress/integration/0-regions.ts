...
const getNorth = () => cy.findByLabelText(/North/)
const getSouth = () => cy.findByLabelText(/South/)
const getEast = () => cy.findByLabelText(/East/)
const getWest = () => cy.findByLabelText(/West/)
